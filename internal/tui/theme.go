...
func newTheme() *theme {
	return &theme{
		...
		diffAdd:     lipgloss.NewStyle().Foreground(lipgloss.Color("0")).Background(lipgloss.Color("32")),
		diffRemove:  lipgloss.NewStyle().Foreground(lipgloss.Color("0")).Background(lipgloss.Color("164")),
